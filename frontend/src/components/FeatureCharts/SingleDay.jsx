...
const SingleDay = ({data, activeFeature, setActiveFeature}) => {
  return (
    <>
        <div className="feature-charts-container">
        <div className="feature-charts-grid">
          {["CPU", "STORAGE", "USERS", "OTHERS"].map((item) => (
            <div
              key={item}
            ...
            <div className="feature-details">
              ...
              {activeFeature === "OTHERS" && (
                <>
                  ...
                  <div className="detail-nav">
                    <div className="detail-nav-item">
                      <h4>{data.economy.cloud_market_demand}</h4>
                    ...
                    <div className="detail-nav-item">
                      <h4>{data.economy.economic_index}</h4>
                  ...
                  <div className="region-resource-list">
                    ...
                    <div className = "region-list">
                      {Object.entries(data.summary.resources_per_region).map(
                        ([region, resources]) => (
